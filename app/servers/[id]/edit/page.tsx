    ...
    return (
      <div className="p-6 max-w-5xl mx-auto">
        <div className="text-center text-red-600">
          <p className="text-lg font-semibold">Error loading server</p>
          <p className="mt-2">{error || 'Server not found'}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Update server information</p>
      </div>
